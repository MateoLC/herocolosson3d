      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="relative group">
            <div className="text-6xl font-black text-outline-variant/20 font-headline absolute -top-8 -left-4 group-hover:text-primary/10 transition-colors">01</div>
          ...
          <div className="relative group">
            <div className="text-6xl font-black text-outline-variant/20 font-headline absolute -top-8 -left-4 group-hover:text-primary/10 transition-colors">02</div>
            <div className="relative pt-4">
          ...
          <div className="relative group">
            <div className="text-6xl font-black text-outline-variant/20 font-headline absolute -top-8 -left-4 group-hover:text-primary/10 transition-colors">03</div>
            <div className="relative pt-4">
          ...
          <div className="relative group">
            <div className="text-6xl font-black text-outline-variant/20 font-headline absolute -top-8 -left-4 group-hover:text-primary/10 transition-colors">04</div>
            <div className="relative pt-4">
