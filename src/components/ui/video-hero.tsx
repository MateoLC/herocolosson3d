...
export const VideoHero = () => {
  return (
    <section className="relative w-full min-h-[100svh] flex flex-col justify-center overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-20 flex flex-col items-start px-4 sm:px-10 md:pl-12 lg:pl-24 pt-24 pb-6 md:pb-12 md:justify-center">
        <div className="flex flex-col items-start text-left">
          ...
          <motion.p 
            ...
            className="mt-12 md:mt-6 max-w-[240px] sm:max-w-xl text-lg sm:text-xl md:text-2xl text-black font-medium text-justify leading-relaxed"
          >
        ...
        >
          <a href="https://wa.me/573246580207" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 bg-transparent hover:bg-white/10 text-black border-2 border-white px-8 py-4 rounded-full font-bold shadow-lg transition-all w-full sm:w-auto text-lg hover:scale-105">
            <FaWhatsapp size={22} />
            WhatsApp
          </a>
          <a href="https://cal.com/mateo-lopez-carvajal-pj7eoq/30min" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 bg-transparent hover:bg-white/10 text-black border-2 border-white px-8 py-4 rounded-full font-bold shadow-lg transition-all w-full sm:w-auto text-lg hover:scale-105">
